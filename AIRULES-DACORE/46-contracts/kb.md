...
This page is the v1 peer contract. A `<Host>` and a knowledge-base pack must be able to interoperate from this page alone. Density matches [filemanager.md](filemanager.md).
