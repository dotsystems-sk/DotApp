...
A `<Host>` and a ledger **pack** must be able to interoperate from this page alone. Density matches [filemanager.md](filemanager.md). This is **not** `invoice` (sales documents) and **not** `report` / `bi` (tables / charts).
