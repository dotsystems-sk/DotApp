...
This page is the **v1 peer contract** for a maps / geocode pack. A host (CMS, Shop, ERP) and a pack must be able to interoperate from this page alone. Density matches [filemanager.md](filemanager.md).
