...
-- Čas generovania: So 10.Máj 2025, 22:02
...
(1, 'admin', 'admin@admin.admin', '$2y$08$qsMcSA02LO8oE4sSE37uNOxkfQrMWZLpisofNWMVs8Ey3QqdbUAG6', 1, 0, '+421', '948858858', 0, 0, 'AAQNAIADADQAAABA', 1, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '2025-05-10 21:35:38');
...
--
-- Štruktúra tabuľky pre tabuľku `erp_users_rm_tokens`
--

DROP TABLE IF EXISTS `erp_users_rm_tokens`;
CREATE TABLE IF NOT EXISTS `erp_users_rm_tokens` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `user_id` int NOT NULL,
  `token` varchar(255) NOT NULL,
  `expires_at` timestamp NOT NULL,
...
--
-- Obmedzenie pre tabuľku `erp_users_rm_tokens`
--
ALTER TABLE `erp_users_rm_tokens`
  ADD CONSTRAINT `erp_users_rm_tokens_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `erp_users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
