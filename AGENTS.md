...
19. **PLAN folder** — new module / rewrite has `app/modules/<This>/PLAN/` (split files); code matches PLAN; unread PLAN = fail. Canonical: `AIRULES/00-AGENT-CONTRACT.md` §2o.
