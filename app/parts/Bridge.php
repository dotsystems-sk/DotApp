...
class Bridge {
    ...
    private function keyExchanger() {
        ...
        $this->dotapp->router->get(["/assets/dotapp/dotapp.js","/assets/dotapp/dotapp.min.js"], function($request) {
            ...
            if (file_exists($dotappjsminfile)) {
                ...
                if (!$this->keyExchange['exchanged']) {
					...
					#exchangenoise() {}
                    ';
                    $dotappJS = str_replace('(){return"A2c9981ddd475413acb6bfbcd9054fb3fcb1690d3"}',$exChange,$dotappJS);
