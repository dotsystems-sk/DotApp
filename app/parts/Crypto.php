...
class Crypto {
    ...
    public static function encrypt($text, $key2 = "") {
        return DotApp::dotAapp()->encrypt($text, $key2);
    }

    public static function encrypta($array, $key2 = "") {
        return DotApp::dotAapp()->encrypta($array, $key2);
    }
    ...
    public static function decrypt($text, $key2 = "") {
        return DotApp::dotAapp()->decrypt($text, $key2);
    }

    public static function decrypta($array, $key2 = "") {
        return DotApp::dotAapp()->decrypta($array, $key2);
    }
