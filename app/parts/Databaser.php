    ...
    private function create_mysqli_driver() {
        ...
        $this->addDriver("mysqli", "execute", function ($success_callback = null, $error_callback = null) use ($getBindingType) {
            ...
            if ($this->cacheDriver && $cached = $this->cacheDriver->get($cacheKey)) {
                $this->dotapp->trigger("dotapp.databaser.execute.success",$cached,$execution_data);
            ...
            if ($stmt === false) {
                ...
                if (is_callable($error_callback)) {
                    $this->dotapp->trigger("dotapp.databaser.execute.error",$error,$execution_data);
            ...
            $this->dotapp->trigger("dotapp.databaser.execute",$execution_data);
            if ($stmt->execute()) {
                ...
                if ($this->returnType === "ORM") {
                    ...
                    if (is_callable($success_callback)) {
                        $this->dotapp->trigger("dotapp.databaser.execute.success",$returnValue,$execution_data);
                    ...
                    $this->dotapp->trigger("dotapp.databaser.execute.success",$rows,$execution_data);
